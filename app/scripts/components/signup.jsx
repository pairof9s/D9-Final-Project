                ...
                <div className="reg-form">
                  <form className="col-xs-12" action="" onSubmit={this.handleSignupSubmit}>
                    ...
                    <div className="form-group col-xs-12">
                      ...
                      <input type="text" value='' className="form-control" id="street1" placeholder="Street address (no P.O.)..." />
                    </div>
                ...
                <div className="row col-md-8">
                  <div className="reg-form">
                    <form className="col-xs-12">
                      ...
                      <div className="form-group col-xs-6">
                          <label htmlFor="email1" className="control-label">Email</label>
                          <input type="email" value='' className="form-control" id="email1" placeholder="parent2@address.com" />
                      </div>
                    </form>
                  </div>
                </div>
